...
<head>
    ...
    <title>
        Kontak Kami - Women's Motor Club
    </title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div id="navbar-collapse-02" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="propClone"><a href="kontak.php" style="color: #FF5599">Kontak Kami</a></li>
                        <li class="propClone">
    ...
    <div class="container toparea">
        <div class="underlined-title">
            <div class="editContent">
                <h1 class="text-center latestitems">Hubungi Kami Sekarang</h1>
            </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <form method="post" action="kontak.php" id="contactform">
                    <div class="form">
